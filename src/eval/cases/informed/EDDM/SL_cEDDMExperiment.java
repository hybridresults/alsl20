package eval.cases.informed.EDDM;
...
public class SL_cEDDMExperiment extends Experiment {

    public SL_cEDDMExperiment(String inputDir, String outputDir) {
    ...
    public List<ExperimentRow> createExperimentRows() {
        ...
        rows.add(new ExperimentRow(
                new InformedFramework(
                        ...
                        new SelfLabelingStrategy(SelfLabelingStrategyType.CEDDM),
                        new EDDM(),
                        false
                ),
                "cEDDM", "0.01"
