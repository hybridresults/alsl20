...
public class SelfLabelingStrategy {

    public double fixedThreshold = 0.9;
    ...
    public boolean assignLabel(Instance instance, double[] predictionValues, double activeLearningFactor,
                               double driftDetectorFactor) {
        boolean label;
        ...
        switch(this.strategy) {
            ...
            case INVERTED_UNCERTAINTY:
                label = this.labelInvertedUncertainty(predictionValue, activeLearningFactor, instance.numClasses()); break;
            case CDDM:
