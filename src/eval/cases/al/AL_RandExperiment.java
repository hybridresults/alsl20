...
public class AL_RandExperiment extends Experiment {
    ...
    public List<ExperimentRow> createExperimentRows() {
        ...
        rows.add(new ExperimentRow(
                new BlindFramework(
                        cls.copy(),
                        new UncertaintyStrategy(UncertaintyStrategyType.RANDOM, 0.01).setVariableThresholdStep(0.01)
                ),
                "ALR", "0.01"
        ));
        rows.add(new ExperimentRow(
                new BlindFramework(
                        cls.copy(),
                        new UncertaintyStrategy(UncertaintyStrategyType.RANDOM, 0.05).setVariableThresholdStep(0.01)
                ),
                "ALR", "0.05"
        ));
        rows.add(new ExperimentRow(
        ...
        rows.add(new ExperimentRow(
                new BlindFramework(
                        cls.copy(),
                        new UncertaintyStrategy(UncertaintyStrategyType.RANDOM, 0.2).setVariableThresholdStep(0.01)
                ),
                "ALR", "0.2"
        ));
        rows.add(new ExperimentRow(
                new BlindFramework(
                        cls.copy(),
                        new UncertaintyStrategy(UncertaintyStrategyType.RANDOM, 0.5).setVariableThresholdStep(0.01)
                ),
                "ALR", "0.5"
        ));
